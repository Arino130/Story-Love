...
setInterval(function() {
    var timespan = countdown(new Date("05/4/2021"), new Date());
    var div = document.getElementById('time');
    div.innerHTML = "<div><span>Năm</span>" + timespan.years + "</div>" + "<div><span>Tháng</span>" + timespan.months + "</div>" + "<div><span>Ngày</span>" + timespan.days + "</div>" + "<div><span>Giờ</span>" + timespan.hours + "</div>" + "<div><span>Phút</span>" + timespan.minutes + "</div>" + "<div><span>Giây</span>" + timespan.seconds + "</div>"
}, 1000);
